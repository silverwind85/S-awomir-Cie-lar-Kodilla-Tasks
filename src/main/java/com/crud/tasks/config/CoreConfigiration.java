...
@EnableSwagger2
@Configuration
public class CoreConfigiration implements WebMvcConfigurer{
    @Bean
    ...
    public void addResourceHandlers(final ResourceHandlerRegistry registry){
        ...
        registry.addResourceHandler("/images/**").addResourceLocations("classpath:/META-INF/resources/webjars/");
